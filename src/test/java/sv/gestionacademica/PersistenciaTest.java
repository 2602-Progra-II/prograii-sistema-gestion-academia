...
public class PersistenciaTest {
    ...
    void testGuardarYObtenerRegistro() {
        ...
        Assertions.assertTrue(guardado, "El registro debería guardarse con éxito");
        
        String resultado = persistenciaService.obtenerRegistro("usr_1");
        Assertions.assertEquals("Roberto Gutierrez", resultado, "El valor recuperado debe coincidir con el almacenado");
    }
    ...
    void testEliminarRegistro() {
        ...
        Assertions.assertTrue(eliminado, "Debería retornar true confirmando la eliminación");
